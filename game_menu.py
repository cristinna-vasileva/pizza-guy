...
class SettingsMenu():
    def __init__(self, w, h, speed):
        ...
        if speed == 2:
            self.info_label = self.labels[2]
        elif speed == 4:
            self.info_label = self.labels[1]
        else:
            self.info_label = self.labels[0]
        
        self.info = FONT.render('СКОРОСТЬ ВРАГА: ' + self.info_label , True, YELLOW)
